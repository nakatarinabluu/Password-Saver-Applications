...
// NEW: App Signature Hash (XOR 0x7F)
unsigned char app_signature[] = { 0x46, 0x49, 0x4C, 0x4F, 0x48, 0x4C, 0x4F, 0x49, 0x4D, 0x47, 0x49, 0x4F, 0x49, 0x49, 0x4E, 0x2A, 0x2A, 0x2F, 0x2E, 0x2E, 0x7F, 0x47, 0x44, 0x4C, 0x2D, 0x2D, 0x46, 0x4F, 0x2E, 0x7E, 0x7F, 0x2C, 0x7F, 0x2C, 0x46, 0x4C, 0x2D, 0x4C, 0x7C, 0x2D, 0x7C, 0x2F, 0x7A, 0x2E, 0x46, 0x2F, 0x4B, 0x2F, 0x4D, 0x2B, 0x47, 0x4B, 0x4E, 0x2E, 0x7D, 0x7E, 0x46, 0x2F, 0x7E, 0x46, 0x7E, 0x48, 0x46, 0x2E, 0x00 };
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_vaultguard_app_security_SecurityManager_getAppSignature(
        JNIEnv* env,
        jobject /* this */) {
    return env->NewStringUTF(decrypt(app_signature, sizeof(app_signature)).c_str());
}

extern "C" JNIEXPORT jboolean JNICALL
Java_com_vaultguard_app_security_SecurityManager_checkFrida(
        JNIEnv* env,
        jobject /* this */) {
    ...
    while (std::getline(maps, line)) {
        if (line.find("frida") != std::string::npos ||
            ...
            line.find("ltrace") != std::string::npos) {
            return JNI_TRUE;
        }
    }
    return JNI_FALSE;
